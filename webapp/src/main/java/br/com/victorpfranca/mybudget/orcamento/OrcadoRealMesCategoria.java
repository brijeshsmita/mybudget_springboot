...
import static br.com.victorpfranca.mybudget.orcamento.OrcadoRealMesCategoria.FIND_ALL;
import static br.com.victorpfranca.mybudget.orcamento.OrcadoRealMesCategoria.FIND_BY_DESPESA_MONTH;
import static br.com.victorpfranca.mybudget.orcamento.OrcadoRealMesCategoria.FIND_BY_RECEITA_MONTH;
...
@NamedQueries({
		@NamedQuery(name = FIND_ALL, query = "SELECT o FROM OrcadoRealMesCategoria o WHERE o.usuario.id = :user"),
		@NamedQuery(name = FIND_BY_DESPESA_MONTH, query = "SELECT o FROM OrcadoRealMesCategoria o where o.usuario.id = :user and ano = :ano and mes = :mes and inOut = '1' order by orcado-realizado asc"),
		@NamedQuery(name = FIND_BY_RECEITA_MONTH, query = "SELECT o FROM OrcadoRealMesCategoria o where o.usuario.id = :user and ano = :ano and mes = :mes and inOut = '0' order by orcado-realizado asc") })
