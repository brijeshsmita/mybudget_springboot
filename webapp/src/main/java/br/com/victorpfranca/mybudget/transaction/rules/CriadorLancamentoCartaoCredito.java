...
public class CriadorLancamentoCartaoCredito {
	...
	@TransactionAttribute(TransactionAttributeType.REQUIRED)
	public Transaction save(Transaction transaction) throws ContaNotNullException, MesLancamentoAlteradoException,
	...
	protected List<Transaction> atualizarFaturas(CreditCardTransaction lancamentoCartao) throws ContaNotNullException {
