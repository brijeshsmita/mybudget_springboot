...
import br.com.victorpfranca.mybudget.orcamento.SaldoOrcadoAcumuladoMes;
...
public class GeradorSaldoFuturo {
	...
	public List<AccountBalance> execute(int anoFrom, int mesFrom, int anoAte, int mesAte) {
		...
		List<AccountBalance> saldosPorMes = agrupadorSaldosMeses.agruparSaldosPorMes(anoFrom, mesFrom, anoAte, mesAte,
