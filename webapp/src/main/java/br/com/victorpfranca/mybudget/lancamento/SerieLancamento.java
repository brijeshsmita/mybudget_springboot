...
import static br.com.victorpfranca.mybudget.lancamento.SerieLancamento.FIND_ALL_QUERY;
...
@NamedQueries({
		@NamedQuery(name = FIND_ALL_QUERY, query = "SELECT l FROM SerieLancamento l WHERE l.usuario.id=:user") })
