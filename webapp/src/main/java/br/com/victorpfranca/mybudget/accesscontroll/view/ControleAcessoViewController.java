...
public class ControleAcessoViewController implements Serializable {
	...
	public void login() {
		try {
			...
			redirect("/modulos/home");
		} catch (AuthenticationException | SameNameException | br.com.victorpfranca.mybudget.account.rules.SameNameException | ContaNotNullException | MesLancamentoAlteradoException | TipoContaException | CategoriasIncompativeisException | ValorLancamentoInvalidoException e) {
