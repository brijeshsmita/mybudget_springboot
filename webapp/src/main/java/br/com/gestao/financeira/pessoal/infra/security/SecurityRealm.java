...
import br.com.gestao.financeira.pessoal.infra.security.jwt.JwtAuthenticationToken;
...
public class SecurityRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        if (email == null) {
            logger.warn("Usuario is null");
            return null;
        }
        try {
            Usuario user = usuarioService.recuperarViaEmail(email);
            if (!user.getAtivo()) {
