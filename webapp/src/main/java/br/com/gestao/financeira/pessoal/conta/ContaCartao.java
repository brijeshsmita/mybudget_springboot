...
public class ContaCartao extends Conta implements Serializable {

	private static final long serialVersionUID = 1L;

	@NotNull(message = "Com qual conta esta fatura será paga?")
	...
	public ContaCartao(String nome) {
		super(nome);
		this.lancamentos = new ArrayList<Lancamento>();
	}
	...
	public Conta getContaPagamentoFatura() {
		return contaPagamentoFatura;
	}

	public void setContaPagamentoFatura(Conta contaPagamentoFatura) {
