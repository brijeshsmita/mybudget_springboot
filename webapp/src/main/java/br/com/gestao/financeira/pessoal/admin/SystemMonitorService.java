...
public class SystemMonitorService {
	...
	public int getQuantidadeNovosUsuariosDiaAtual() {
		return em
				.createQuery("select count(u) from Usuario u where dataCadastro >=:today and dataCadastro < :tomorrow",
						Long.class)
	...
	public int getQuantidadeNovosUsuariosDiaAnterior() {
		return em
				.createQuery(
						"select count(u) from Usuario u where dataCadastro >= :yesterday and dataCadastro < :today",
						Long.class)
	...
	public int getQuantidadeNovosUsuariosUltimosDias(int qtdDias) {
		...
		return em
				.createQuery(
						"select count(u) from Usuario u where dataCadastro >= :dayOne and dataCadastro < :tomorrow",
						Long.class)
