...
import static br.com.gestao.financeira.pessoal.LocalDateConverter.*;
...
public class CalcularDataFechamentoFaturaTest {
	...
	public void testFechamentoProximo_fechamentoDia31_Mes30Dias() {
		...
		contaCartao.setCartaoDiaFechamento(DAY_OF_MONTH_31);

		Date dataReferencia = toDate(LOCALDATE_2000_04_30);
		Date dataFechamentoProximo = contaCartao.getDataFechamentoProximo(dataReferencia);
	...
	public void testFechamentoProximo_fechamentoDia29_MesFevereiro_AnoNaoBissexto() {
		ContaCartao contaCartao = new ContaCartao();
		contaCartao.setCartaoDiaFechamento(DAY_OF_MONTH_29);
	...
	public void testFechamentoProximo_referenciaIgualFechamento() {
		ContaCartao contaCartao = new ContaCartao();
		contaCartao.setCartaoDiaFechamento(DAY_OF_MONTH_1);
