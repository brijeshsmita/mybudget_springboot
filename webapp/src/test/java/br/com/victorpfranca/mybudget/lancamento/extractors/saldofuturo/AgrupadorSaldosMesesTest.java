...
import br.com.victorpfranca.mybudget.lancamento.extractors.saldofuturo.AgrupadorSaldosMeses;
...
public class AgrupadorSaldosMesesTest {
    ...
    public void validaMesesVazios_12Meses() {
        Set<AccountBalance> conjuntoMeses = new TreeSet<>(Comparator.comparing(s->new AnoMes(s.getAno(), s.getMes())));
